...
:root {
    --color-bg: #0E1117;
    --color-bg-card: #1E2127;
    --color-bg-sidebar: #1E2127;
    --color-bg-input: #1E2127;
    --color-bg-user: linear-gradient(135deg, rgba(108, 92, 231, 0.15) 0%, rgba(108, 92, 231, 0.05) 100%);
...
/* Force Streamlit native elements to dark mode where needed */
.stApp {
...
section[data-testid="stSidebar"] .stMarkdown p, section[data-testid="stSidebar"] .stMarkdown h1, section[data-testid="stSidebar"] .stMarkdown h2 {
    color: var(--color-text) !important;
}
.app-hero {
    background: rgba(30, 33, 39, 0.65) !important;
    border-color: var(--color-border) !important;
}
[data-testid="stChatMessage"] {
    background: rgba(30, 33, 39, 0.75) !important;
    border-color: var(--color-border) !important;
}
[data-testid="stChatMessage"]:has([data-testid="chatAvatarIcon-assistant"]) {
...
[data-testid="stChatInput"] {
    background: rgba(30, 33, 39, 0.92) !important;
...
.evidence-card {
    background: rgba(30, 33, 39, 0.7) !important;
    border-color: var(--color-border) !important;
}
.starter-grid .stButton > button {
    background: var(--color-bg-card) !important;
